...
static ample::utils::Factory<game::StateMachine::Transition, const std::string &, std::shared_ptr<game::StateMachine::State>>::Register<game::KeyboardTransition> KeyboardTransitionRegister("KeyboardTransition");
